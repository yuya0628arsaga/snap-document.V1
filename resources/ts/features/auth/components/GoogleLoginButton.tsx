...
const GoogleLoginButtonWrapper = styled('a')`
    > .gsi-material-button {
 ...
 * Googleログインボタン
 */
const GoogleLoginButton = React.memo((props: GoogleLoginButtonPropsType) => {
    const { googleLoginUrl } = props

    return (
        <GoogleLoginButtonWrapper href={googleLoginUrl}>
